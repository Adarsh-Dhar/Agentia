...
> Sleep soundly. Let AI trade at 100ms on Initia.

A modern, production-ready autonomous AI trading platform built with Next.js 16, React 19, and TypeScript.

## Overview

Agentia is a comprehensive platform for deploying and managing autonomous AI trading agents powered by cryptographically secure session keys on the Initia blockchain. The application features:
...
### Landing Page (/)
- Hero section with compelling headline: "Sleep soundly. Let AI trade at 100ms on Initia."
...
- Network selection (Arbitrum, Ethereum, Polygon)
...
- **Wallet Connection**: InterwovenKit modal (component prepared)
- **Trading APIs**: Initia blockchain endpoints
