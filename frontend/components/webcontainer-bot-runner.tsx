...
export function WebContainerBotRunner() {
  ...
  const autosignEnabled =
    autoSign?.isEnabledByChain?.[TESTNET.defaultChainId] ?? false;
  ...
  useEffect(() => {
    ...
    if (!autosignEnabled) {
      termRef.current?.writeln(
        "\x1b[33m[System]\x1b[0m AutoSign is required before launch. Enable AutoSign in the sidebar."
      );
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span
            style={{
              ...
              padding: "2px 8px",
              borderRadius: 4,
              border: `1px solid ${autosignEnabled ? "rgba(34,197,94,0.3)" : "rgba(239,68,68,0.3)"}`,
              color: autosignEnabled ? "#4ade80" : "#fca5a5",
              display: "flex",
              alignItems: "center",
              gap: 4,
            }}
          ...
          {isRunning ? (
            ...
            <button
              ...
              style={{
                ...
                fontSize: 11,
                fontWeight: 700,
                cursor: autosignEnabled ? "pointer" : "not-allowed",
                fontFamily: "inherit",
              }}
            >
